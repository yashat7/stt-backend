...
export declare class FieldsClient {
     ...
     *     })
     */
    list(project_id: string, request?: Deepgram.manage.v1.projects.usage.FieldsListRequest, requestOptions?: FieldsClient.RequestOptions): core.HttpResponsePromise<Deepgram.UsageFieldsV1Response>;
    private __list;
}
