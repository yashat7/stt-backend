...
export declare namespace AgentV1UpdateSpeakSpeakProvider {
    ...
    namespace AgentV1UpdateSpeakSpeakProviderDeepgram {
        /** Deepgram TTS model */
        const Model: {
    ...
    namespace AgentV1UpdateSpeakSpeakProviderOpenAi {
        /** OpenAI TTS model */
        const Model: {
            readonly Tts1: "tts-1";
    ...
    namespace AgentV1UpdateSpeakSpeakProviderAwsPolly {
        /** AWS Polly voice name */
        const Voice: {
