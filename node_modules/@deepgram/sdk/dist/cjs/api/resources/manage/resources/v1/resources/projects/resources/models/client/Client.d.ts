...
export declare class ModelsClient {
     ...
     *     })
     */
    list(project_id: string, request?: Deepgram.manage.v1.projects.ModelsListRequest, requestOptions?: ModelsClient.RequestOptions): core.HttpResponsePromise<Deepgram.ListModelsV1Response>;
    private __list;
    /**
     ...
     */
    get(project_id: string, model_id: string, requestOptions?: ModelsClient.RequestOptions): core.HttpResponsePromise<Deepgram.GetModelV1Response>;
    private __get;
}
