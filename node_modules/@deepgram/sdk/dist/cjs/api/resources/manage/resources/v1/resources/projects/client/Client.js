...
const Client_js_1 = require("../resources/billing/client/Client.js");
const Client_js_2 = require("../resources/keys/client/Client.js");
const Client_js_3 = require("../resources/members/client/Client.js");
const Client_js_4 = require("../resources/models/client/Client.js");
const Client_js_5 = require("../resources/requests/client/Client.js");
const Client_js_6 = require("../resources/usage/client/Client.js");
class ProjectsClient {
    ...
    get keys() {
        var _a;
        return ((_a = this._keys) !== null && _a !== void 0 ? _a : (this._keys = new Client_js_2.KeysClient(this._options)));
    }
    get members() {
        var _a;
        return ((_a = this._members) !== null && _a !== void 0 ? _a : (this._members = new Client_js_3.MembersClient(this._options)));
    }
    get models() {
        var _a;
        return ((_a = this._models) !== null && _a !== void 0 ? _a : (this._models = new Client_js_4.ModelsClient(this._options)));
    }
    get requests() {
        var _a;
        return ((_a = this._requests) !== null && _a !== void 0 ? _a : (this._requests = new Client_js_5.RequestsClient(this._options)));
    }
    get usage() {
        var _a;
    ...
    __list(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects");
        });
    }
    /**
    ...
    __get(project_id_1) {
        return __awaiter(this, arguments, void 0, function* (project_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}");
        });
    }
    /**
    ...
    __delete(project_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/v1/projects/{project_id}");
        });
    }
    /**
    ...
    __update(project_id_1) {
        return __awaiter(this, arguments, void 0, function* (project_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/v1/projects/{project_id}");
        });
    }
    /**
    ...
    __leave(project_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/v1/projects/{project_id}/leave");
        });
    }
}
