...
exports.PurchasesClient = void 0;
...
class PurchasesClient {
    ...
    __list(project_id_1) {
        return __awaiter(this, arguments, void 0, function* (project_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/purchases");
        });
    }
}
