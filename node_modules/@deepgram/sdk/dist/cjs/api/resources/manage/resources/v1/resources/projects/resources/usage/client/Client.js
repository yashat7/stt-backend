...
const Client_js_1 = require("../resources/breakdown/client/Client.js");
const Client_js_2 = require("../resources/fields/client/Client.js");
class UsageClient {
    constructor(options = {}) {
    ...
    get breakdown() {
        var _a;
        return ((_a = this._breakdown) !== null && _a !== void 0 ? _a : (this._breakdown = new Client_js_1.BreakdownClient(this._options)));
    }
    get fields() {
        var _a;
        return ((_a = this._fields) !== null && _a !== void 0 ? _a : (this._fields = new Client_js_2.FieldsClient(this._options)));
    }
    /**
     * @deprecated
     *
    ...
    __get(project_id_1) {
        return __awaiter(this, arguments, void 0, function* (project_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/usage");
        });
    }
}
