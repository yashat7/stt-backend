...
export declare class BalancesClient {
     ...
     */
    list(project_id: string, requestOptions?: BalancesClient.RequestOptions): core.HttpResponsePromise<Deepgram.ListProjectBalancesV1Response>;
    private __list;
    /**
     ...
     */
    get(project_id: string, balance_id: string, requestOptions?: BalancesClient.RequestOptions): core.HttpResponsePromise<Deepgram.GetProjectBalanceV1Response>;
    private __get;
}
