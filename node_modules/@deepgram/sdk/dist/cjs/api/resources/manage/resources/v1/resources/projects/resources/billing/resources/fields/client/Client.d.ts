...
export declare class FieldsClient {
     ...
     *     })
     */
    list(project_id: string, request?: Deepgram.manage.v1.projects.billing.FieldsListRequest, requestOptions?: FieldsClient.RequestOptions): core.HttpResponsePromise<Deepgram.ListBillingFieldsV1Response>;
    private __list;
}
